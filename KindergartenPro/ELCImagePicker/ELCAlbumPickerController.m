...
- (void)viewDidLoad
{
    ...
    [r_button setTitle:@"取消" forState:UIControlStateNormal];
    ...
    [r_button addTarget:self.parent action:@selector(cancelImagePicker) forControlEvents:UIControlEventTouchUpInside];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ALAssetsGroup *g = (ALAssetsGroup*)[self.assetGroups objectAtIndex:indexPath.row];
    [g setAssetsFilter:[ALAssetsFilter allPhotos]];
	picker.title = [NSString stringWithFormat:@"%@",[g valueForProperty:ALAssetsGroupPropertyName]];
