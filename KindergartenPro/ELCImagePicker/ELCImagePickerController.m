...
//        {
//            UIImage* t_image = [UIImage imageNamed:@"top-bar.png"];
//            [self.navigationBar setBackgroundImage:t_image forBarMetrics:UIBarMetricsDefault];
...
- (BOOL)shouldSelectAsset:(ELCAsset *)asset previousCount:(NSUInteger)previousCount
{
    ...
    if (!shouldSelect) {
        NSString *title = [NSString stringWithFormat:@"一次最多添加%i张照片", self.maximumImagesCount];
